...
| [retronet-cpm](https://github.com/retronet-labs/retronet-cpm) | v0.4.0 | Ambiente CP/M-like didattico sopra l'8080: loader `.COM`, BDOS subset file read/write opt-in, shell `A>`, terminale condiviso, command tail e FCB default sintetici. |
